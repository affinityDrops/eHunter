    ...
    <nav class="top-bar">
        ...
        <div :class="['inner-content', { hide: !showTopBar, 'more-settings': showMoreSettings }]" :style="topBarStyle">
            <template v-if="readSettings">
                ...
                <div class="item">
                    <a class="label icon tips tips-down clickable" :title-content="string.introTip" :href="introHref">
                      <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 35 35" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g>
                        <path d="M0,0v35h35V0H0z M33,33H2V2h31V33z" />
                        <path d="M14 4.5h7v7H14Z" />
                        <path d="M14 14h7v7H14Z" />
                        <path d="M14 23.5h7v7H14Z" />
                        <path d="M4.5 4.5h7v7H4.5Z" />
                        <path d="M4.5 14h7v7H4.5Z" />
                        <path d="M4.5 23.5h7v7H4.5Z" />
                        <path d="M23.5 4.5h7v7H23.5Z" />
                        <path d="M23.5 14h7v7H23.5Z" />
                        <path d="M23.5 23.5h7v7H23.5Z" /> </g> </g> </g>
                      </svg>
                    </a>
                </div>
                <div class="item">
...
export default {
    ...
    data() {
        return {
            ...
            configurationBoard: {},
            introHref: this.service.album.getIntroUrl(),
        };
    },
